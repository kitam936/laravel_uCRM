...
const form = useForm({
    ...
    name: props.customer.name, kana: props.customer.kana, tel: props.customer.tel,
    email: props.customer.email, postcode: props.customer.postcode,
    address: props.customer.address, birthday: props.customer.birthday,
    gender: props.customer.gender, memo: props.customer.memo
})
                            ...
                            <div class="container px-5 py-8 mx-auto">
                                ...
                                <div class="flex flex-wrap -m-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" id="id" name="id" v-model="form.id" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                        <div v-if="errors.name" class="text-red-500">{{ errors.id }}</div>
                                    </div>
                                    </div>
                                    <div class="p-2 w-full">
                                    <div class="relative">
                                    ...
                                    <div class="p-2 w-full">
                                    <div class="relative">
                                        <label class="mr-4 leading-7 text-sm text-gray-600">性別</label>
                                        ...
                                        <label for="gender2" class="ml-2 mr-2">回答なし</label>
                                    </div>
                                    </div>

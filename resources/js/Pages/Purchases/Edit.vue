                    ...
                    <div class="p-6 text-gray-900">
                        <section class="text-gray-600 body-font relative">
                            ...
                            <div class="flex flex-wrap -m-2">
                                ...
                                <div class="relative ">
                                        <label for="pur_id" class="mr-6 leading-7 text-sm text-gray-600">No</label>
                                        <input disabled type="text" id="pur_id" name="pur_id" :value="form.id" class="w-40 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                </div>
                                </div>
                                ...
                                <div class="relative">
                                    ...
                                    <input disabled type="date" id="date" name="date" :value="form.date" class="w-40 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                ...
                                <input  disabled name="cs_id" :value="form.customer_id" class="mr-4 w-24 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                </div>
                                <div>
                                <label for="cs_name" class="mr-2 leading-7 text-sm text-gray-600">名前</label>
                                <input  disabled name="cs_name" :value="form.customer_name" class="w-60 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                </div>
                                ...
                                <div class="p-2 w-full">
                                <div class="relative">
                                    <label for="status" class="mr-4 leading-7 text-sm text-gray-600">Status</label>
                                    <input type="radio" id="status" name="status" v-model="form.status" value="1" >未キャンセル
                                    <input type="radio" id="status" name="status" v-model="form.status" value="0" >キャンセル
                                    <!-- <div v-if="errors.date" class="text-red-500">{{ errors.date }}</div> -->
                                </div>
                                </div>
